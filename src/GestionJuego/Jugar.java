...
public class Jugar {
     ...
     * @throws IOException
     */
    private static void jugarDificil(int opcionMenu, int max, int min, Boolean lvlPasado, boolean salirJuego, int reAcertadas,  int enunciado, int dificultad, String colorPj, String COLOR_RESET, String colorPo) throws IOException {
        int reJugador;
        String[] opciones;
    ...
    private static void jugarFaMe(int opcionMenu, int max, int min, Boolean lvlPasado, boolean salirJuego, int reAcertadas, int enunciado, int dificultad, String colorPj, String COLOR_RESET, String colorPo) throws IOException {
        int reJugador;
        String[] opciones;
        String respuestaElegida;
        GestionPreguntas gp = new GestionPreguntas();
        ...
        do{ //Repite hasta que el jugador indique que quiera salir. Más adelante, cuando se
            ...
            if (re1=='S') {
                ...
                if (jugar==true) { //Inicio del juego
                    ...
                    if (dificultad==2) {   
                        jugarDificil(opcionMenu, max, min, lvlPasado, salirJuego, reAcertadas, enunciado, dificultad, colorPj, COLOR_RESET, colorPo); 
                    }else{
                        jugarFaMe(opcionMenu, max, min, lvlPasado, salirJuego, reAcertadas, enunciado, dificultad, colorPj, COLOR_RESET, colorPo); 
                    }
